...
(progn
  ...
  (define-key *bc-menu-mode-map* "q"        'bc-menu-generic-close-buffer)
...
\\[bc-menu-generic-close-buffer] -- close the *breadcrumbs* window
"
...
(defun bc-menu-generic-close-buffer ()
